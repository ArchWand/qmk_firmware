...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_QW] = LAYOUT_ortho_5x15( /* QWERTY */
		...
		KC_LGUI, KC_LCTL, KC_LGUI, KC_LALT, LAYER,   KC_SPC,  KC_LEFT, KC_DOWN, KC_RGHT, KC_BSPC, MO(_SM), KC_DEL,  KC_RALT, KC_RGUI, KC_RCTL
	 ),
     ...
     * '--------------------------------------------------------------------------------------------------------------------------------------'
     */
    [_SM] = LAYOUT_ortho_5x15( /* SYMBOLS */
		KC_GRV,  KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC, _______, _______, _______, KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, _______,
        _______, _______, KC_AT,   KC_HASH, KC_AMPR, KC_TILD, _______, _______, _______, KC_LCBR, KC_RCBR, KC_LT,   KC_GT,   KC_ASTR, KC_DQUO,
        _______, KC_EXLM, KC_PERC, KC_CIRC, KC_DLR,  KC_GRV,  _______, _______, _______, KC_LPRN, KC_RPRN, KC_LBRC, KC_RBRC, KC_COLN, _______,
        _______, _______, _______, _______, _______, KC_UNDS, _______, _______, _______, KC_MINS, KC_PLUS, KC_EQL,  _______, KC_BSLS, _______,
