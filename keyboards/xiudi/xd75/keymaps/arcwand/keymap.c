...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[_GT] = LAYOUT_ortho_5x15( /* GOTO */
		...
		_______, _______, _______, TO(_KB), TO(_MD), KC_CIRC, _______, _______, _______, KC_HOME, KC_PGDN, KC_PGUP, KC_END,  _______, _______,
		_______, _______, TO(_AP), TO(_NP), TO(_MV), KC_PERC, _______, PLOVER,  _______, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, _______, KC_ENT,
		_______, KC_BSLS, _______, _______, KC_DLR,  KC_TILD, _______, _______, _______, KC_LBRC, KC_RBRC, _______, _______, _______, _______,
